    ...
    public static void main(String[] args) {
        ...
        while (!finalizarSistema) {            
            ...
            switch(opcao){
                ...
                switch (tipoEntrega) {
                    case 1 -> minhaVenda.setTipoEntrega(TipoEntrega.RETIRADA_LOCAL);
                    case 2 -> minhaVenda.setTipoEntrega(TipoEntrega.SEDEX);
                    case 3 -> minhaVenda.setTipoEntrega(TipoEntrega.ENCOMENDA_PAC);
                    default -> {
                    }
                }
